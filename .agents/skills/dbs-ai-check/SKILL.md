...
以下是从实际改写对话中提炼的用户写作偏好，检测和改写时作为参照基准。

**语气特征**
- 口语化，自然带入「说实话」「其实」「就没下文」等语气词
- 结尾习惯留白，不用格言或金句收束
- 承认不确定时直接说，不绕弯

**结构偏好**
- 不喜欢四象限式枚举（如「内容、用户、品牌、系统」），只说自己真正在意的那一个
- 喜欢用具体项目/数字作为论据（如「羊毛毡做了三四个月之后才确认」），不用抽象感悟替代
- 段落之间留呼吸感，不喜欢大段密文

**改写原则**
- 改写时优先保留他的原话和用词，只调整结构和段落
- 不替他升华结论，他说没想清楚就留没想清楚
- 「比如」「其实」「但是」这类口语连接词保留，不替换成书面连接词
